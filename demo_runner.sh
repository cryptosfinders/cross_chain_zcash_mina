...
echo "Usage: demo_runner.sh --fee-payer-key ./fee_payer_key.json --zkapp-address <BRIDGE_ZKAPP_ADDRESS>"
if [ "$#" -lt 2 ]; then
...
echo "Demo runner finished. Follow onscreen instructions to `zk send` the generated proof to the zkApp."
